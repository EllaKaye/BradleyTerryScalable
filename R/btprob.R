...
#'
#' Calculates the Bradley-Terry probabilities of each item in a fully-connected component of \eqn{G_W} winning against every other item in that component.
#'
...
#' btprob(fit3)
#' @export
btprob_old <- function(object, as_df = FALSE) {
