...
#'
#' \code{graph_to_matrix} is a data manipulation function that converts a graph representation of wins data into a square matrix. This is a helper function for \code{\link{btdata}}.
#' 
